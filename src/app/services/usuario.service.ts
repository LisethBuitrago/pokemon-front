...
export class UsuarioService {
  ...
  crearUsuario(
    ...
    return this.cliente.post(
      this.urlbase +
        ...
        '&idiomaPreferido=' +
        encodeURIComponent(idiomaPreferido) +
        '&dinero=' +
        dinero,
      null,
      { responseType: 'text' },
  ...
  buscarPorNombre(nombre: string) {
    return this.cliente.get<UsuarioModel[]>(
      this.urlbase + '/usuario/buscarpornombre?nombre=' + encodeURIComponent(nombre),
      {
        observe: 'response',
      },
    );
  ...
  buscarPorCorreo(correo: string) {
    return this.cliente.get<UsuarioModel[]>(
      this.urlbase + '/usuario/buscarporcorreo?correo=' + encodeURIComponent(correo),
      {
        observe: 'response',
      },
    );
  ...
  buscarPorRol(rol: string) {
    return this.cliente.get<UsuarioModel[]>(
      this.urlbase + '/usuario/buscarporrol?rol=' + encodeURIComponent(rol),
      {
        observe: 'response',
      },
    );
